...
extern AED_REAL *sed_zone_heat;   //# prescribed net bed->water power per zone [W] (sed_heat_model==3)
...
extern AED_REAL oxy_recirc_return_height_min; //# bottom of the optional return band (m; <0 = unset)
extern AED_REAL oxy_recirc_return_height_max; //# top of the optional return band (m; <0 = unset)
