        ...
        if (benthic_mode == 1) {
            ...
            if ( sed_heat_model == 2 ){
              ...
              for (z = 1; z < n_zones; z++) {
                  ...
                  SoilTemp( &sed_layers,   // theZones(z).n_sedLayers,
                            sed_depths,   // theZones(z).c_layers.depths,
                            sed_vwc,      // theZones(z).c_layers.vwc,
                            &sed_temps[0], // theZones(z).ztemp,
                            sed_temps,    // theZones(z).c_layers.temp,
                            &soil_heat_flux );
